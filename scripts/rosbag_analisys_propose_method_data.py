...
for topic, msg, t in bag.read_messages():
    if topic=="/data":
        ...
        np_pose[0,2]=60 - msg.data[4]
        np_pose[0,3]=60 - msg.data[5]
        np_pose[0,4]=60 - msg.data[6]
        np_pose[0,5]=60 - msg.data[7]
        
        if np_pose[0,2] < 1:
            np_pose[0,2]=0
        elif np_pose[0,2] < 45:
            np_pose[0,2]=(-4*np_pose[0,2]/3) + 30
        else:
            np_pose[0,2]=10
        ...
        if np_pose[0,3] < 1:
            ...
            np_pose[0,3]=(-4*np_pose[0,3]/3) + 30
        else:
            np_pose[0,3]=10
        ...
        if np_pose[0,4] < 1:
            ...
            np_pose[0,4]=(-4*np_pose[0,4]/3) + 30
        else:
            np_pose[0,4]=10
        ...
        if np_pose[0,5] < 1:
            ...
            np_pose[0,5]=(-4*np_pose[0,5]/3) + 30
        else:
            np_pose[0,5]=10
...
ax1.axvline(x=1.3, color='red', linestyle='--')
ax1.axhline(y=0, color='gray', linestyle='--')
#ax1.axvline(x=1.73, color='red', linestyle='--')
ax1.axvline(x=2.06, color='red', linestyle='--')
#ax1.axhline(y=7.7, color='gray', linestyle='--')
#####################################################################################
ax2.axvline(x=1.3, color='red', linestyle='--')
ax2.axhline(y=0, color='gray', linestyle='--')
#ax2.axvline(x=1.73, color='red', linestyle='--')
ax2.axvline(x=2.06, color='red', linestyle='--')
#ax2.axhline(y=7.7, color='gray', linestyle='--')
#######################################################################################
ax3.axvline(x=1.3, color='red', linestyle='--')
ax3.axhline(y=0, color='gray', linestyle='--')
#ax3.axvline(x=1.73, color='red', linestyle='--')
ax3.axvline(x=2.06, color='red', linestyle='--')
#ax3.axhline(y=7.7, color='gray', linestyle='--')
#####################################################################################
ax4.axvline(x=1.3, color='red', linestyle='--')
ax4.axhline(y=0, color='gray', linestyle='--')
#ax4.axvline(x=1.73, color='red', linestyle='--')
ax4.axvline(x=2.06, color='red', linestyle='--')
#ax4.axhline(y=7.7, color='gray', linestyle='--')
####################################################################################
